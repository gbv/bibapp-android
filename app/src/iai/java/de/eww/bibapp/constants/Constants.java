...
public final class Constants
{
    ...
    public static String getDaiaUrl(String ppn, boolean isLocal, int localCatalogIndex)
    {
        if ( isLocal == true )
        {
            return "https://paia.gbv.de/" + Constants.DAIA_BIB_CODES[localCatalogIndex] + "/daia?id=ppn:" + ppn + "&format=json";
        }
        else
        {
    ...
    {
        return "http://unapi.gbv.de/?id=gvk:ppn:" + ppn + "&format=" + format;
    }
